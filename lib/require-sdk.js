/**
 * Taken from https://github.com/azer/require-sdk since the package was
 * removed from the `npm` registry and broke our build.
 * All credits to `azer` and other original authors
 */
